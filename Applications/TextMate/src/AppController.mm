...
// betas, anything else sees releases only. The Updates preferences pane
// sets it.
...
// The Check Now button in the Updates preferences sends this as a nil-target action, and the
