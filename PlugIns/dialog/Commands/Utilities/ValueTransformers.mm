...
static NSString* NSStringFromColor (NSColor* aColor)
{
  ...
  // The generic RGB color space is the modern spelling of
  // NSCalibratedRGBColorSpace, so this still round trips with the colorWithCalibratedRed:… above.
	aColor = [aColor colorUsingColorSpace:NSColorSpace.genericRGBColorSpace];
